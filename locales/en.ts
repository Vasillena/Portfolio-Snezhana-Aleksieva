export default {
  ...
  about: {
    ...
    "card-2-text-3": "Sep 2011 - Jan 2016",
    "card-2-text-4": "Boyana Developers",
    "card-2-text-5": "Sales & Events Manager",
    "card-2-text-6": "Feb 2016 - Dec 2024",
    "card-2-text-7": "Thracian Hoteliers",
    "card-2-text-8": "Marketing Specialist",
    "card-2-text-9": "Nov 2017 - Dec 2024",
    "card-2-text-10": "Freelance",
    "card-2-text-11": "Graphic Designer",
    "card-2-text-12": "Oct 2023 - Dec 2024",
    "card-2-text-13": "Sky Prime",
    "card-2-text-14": "Graphic Designer",
    "card-2-text-15": "Dec 2024 - Present",
    "card-3-title": "Tools",
    "card-4-title": "Languages",
    "card-4-text-1": "Bulgarian",
    "card-4-text-2": "English",
    "card-5-title": "Creative Fields",
    "card-5-text-1": "Social Media Campaigns",
    "card-5-text-2": "Visual Identity",
    "card-5-text-3": "Brand Communication",
    "card-5-text-4": "Editorial & Layout Design",
    "card-5-text-5": "UX/UI Design",
    "card-6-title": "Soft Skills",
    "card-6-text-1": "Analytical thinking",
    "card-6-text-2": "Attention to detail",
    "card-6-text-3": "Time managment",
    "card-6-text-4": "Structured communication",
    "card-6-text-5": "Creative problem-solving",
    "card-6-text-6": "Systems thinking",
